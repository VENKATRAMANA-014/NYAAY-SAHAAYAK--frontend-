...
const Rights = () => {
  return (
    <div className="know-your-rights-container" style={{padding:"50px"}}>

      <h1 className="title">Know Your Rights and Sections</h1>
      <ul className="rights-list">
        {rightsData.map((right, index) => (
          <li key={index} className="right-item">
            <h2 className="right-title" style={{margin:"10px",fontSize:"35px"}}>{right.head}</h2>
            <h2 className="right-title" style={{marginTop:"10px",fontSize:"24px"}}>{right.title}</h2>
            <p className="right-description" style={{textAlign:"left"}}>{right.description}</p>
          </li>
        ))}
      </ul>
    </div>
...
//     axios.get('http://localhost:5000/cpcs')
