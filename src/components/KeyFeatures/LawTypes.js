            ...
            <div class="row">
                ...
                <button class="lawsession">
                   ...
                   <div class="col-md-4" style={{marginBottom:"20px"}}>
                    <Link to="/contract">
                        <button class="lawsession">
                        <img src="https://res.cloudinary.com/dtnvkccyy/image/upload/v1706346097/yk2fwvl52kk0jf9oevpe.jpg" class="img" alt="Online Appointment Booking Logo" />
                        <h3>Contract Law</h3>
                        </button>
                    </Link>
                   </div>
                   ...
                   <div class="col-md-4" style={{marginBottom:"20px"}}>
                    <Link to="/administrative">
                        <button class="lawsession">
                        <img src="https://res.cloudinary.com/dtnvkccyy/image/upload/v1706346055/affehjcyr6hdrzfjqe2z.jpg" class="img" alt="Online Appointment Booking Logo" />
                   ...
                   <div class="col-md-4" style={{marginBottom:"20px"}}>
                    <Link to="/statutory">
                        <button class="lawsession">
                        <img src="https://res.cloudinary.com/dtnvkccyy/image/upload/v1706346015/qfeip5w85reucanrimwn.jpg" class="img" alt="satutory law" />
                        <h3>Statutory law</h3>
                        </button>
                    </Link>
                   </div>
                   ...
                   <div class="col-md-4" style={{marginBottom:"20px"}}>
                    <Link to="/energy">
                        <button class="lawsession">
                        <img src="https://res.cloudinary.com/dtnvkccyy/image/upload/v1706345973/b7vh20dcvgtyxtlhcwv5.jpg" class="img" alt="enegry law" />
                        <h3>Energy law</h3>
                        </button>
                    </Link>
                   </div>
                   ...
                   <div class="col-md-4" style={{marginBottom:"20px"}}>
                    <Link to="/international">
                        <button class="lawsession">
                        <img src="https://res.cloudinary.com/dtnvkccyy/image/upload/v1706345846/cbkrpldlbtklwajcrwpu.jpg" class="img" alt="international law" />
                   ...
                   <div class="col-md-4" style={{marginBottom:"20px"}}>
                    <Link to="/hindu">
                        <button class="lawsession">
                        <img src="https://hindi.livelaw.in/h-upload/2020/09/01/750x450_380811-hindulaw7.jpg" class="img" alt="international law" />
                        <h3>Hindu law</h3>
                        </button>
                    </Link>
                   </div>
                   ...
                   <div class="col-md-4" style={{marginBottom:"20px"}}>
                    <Link to="/enforcemrnt">
                        <button class="lawsession">
                        <img src="https://res.cloudinary.com/dtnvkccyy/image/upload/v1706345924/hw0uphaopfecgxy2ze87.jpg" class="img" alt="international law" />
                   ...
                   <div class="col-md-4" style={{marginBottom:"20px"}}>
                    <Link to="/sharia">
                        <button class="lawsession">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-lHosJWYYw_VBYFLbgwPyJxu8ThnZD4vRQw&usqp=CAU" class="img" alt="international law" />
                        <h3>Sharia law</h3>
                        </button>
                    </Link>
                   </div>
