  ...
  const [backenddata,setbackenddata]=useState([{}])
        useEffect(()=>{
          ...
          .then(data=>{console.log(data);
            setbackenddata(data.family_related_faqs);
...
<h3>Family law</h3>
Family law, in India is a diverse field that deals with a range of legal matters that are crucial to family life. It covers secular laws each tailored to meet the specific requirements and customs of different
 communities within the country. From marriage and divorce 
to child custody, inheritance, adoption and protection against violence family law plays 
a role in regulating and protecting familial relationships. As India continues to progress socially and legally family law evolves to meet needs while upholding traditional values.
 Legislative reforms, court interpretations and landmark cases have collectively shaped the landscape of family law in India by emphasizing principles, like gender equality and the best interests of children
       </div>
